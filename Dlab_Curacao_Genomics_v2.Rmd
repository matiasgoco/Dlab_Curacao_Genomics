...
copy file diploria2_SNPs_2alleles_30phred_30x_50missgen_50missind_NoClones_neutral_maf05_hwe01_LD1000.recode.phylip, this is the same file as previous analysis where I excluded outlier loci, but since we saw that even leeping those loci they end up being removed during the HWE filtering, I am using the excat same file

```{bash,  eval=FALSE}
cp /project/pi_prada_uri_edu/mgomez/curaçao/snp_filtering/analysis_v2/phylogenetics/diploria2_SNPs_2alleles_30phred_30x_50missgen_50missind_NoClones_neutral_maf05_hwe01_LD1000.recode.phylip .
```
